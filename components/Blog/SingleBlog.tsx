import { PostRecord, ResponsiveImage } from '@/graphql/generated';
  ...
  return (
    <>
      <div className="relative h-full overflow-hidden rounded-xl bg-white shadow-one dark:bg-dark">
        <Link href={'/posts/' + slug} className="relative block w-full overflow-hidden h-[230px]">
        ...
        <div className="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-8 2xl:p-8">
          ...
          <div className="flex h-full items-center justify-between">
            ...
            <div className="inline-block">
              <div className="text-xs text-body-color">{transformDate(_publishedAt)}</div>
            </div>
          </div>
        </div>
      </div>
