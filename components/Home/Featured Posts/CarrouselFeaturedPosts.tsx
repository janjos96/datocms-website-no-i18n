...
import { PostRecord } from '@/graphql/generated';
...
const CarrouselFeaturedPosts = ({ blogData, blogHeader, blogSubheader }: BlogProps) => {
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
          ...
          <div className="mt-6 lg:mx-6 lg:mt-0 lg:w-1/2">
            <p className="text-sm uppercase text-blue-500">{currentReview.tags[0].tag}</p>
            ...
            <div className="mt-8">
              ...
              >
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                </svg>
              </button>
              <button
                onClick={handleNext}
